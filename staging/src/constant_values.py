...
def get_general_stat_ids():
    return ['game_id', 'year_id', 'game_date', 'game_num', 'age', 'team', 'position', 'game_location', 'opp',
            'game_result', 'gs']
...
def get_passing_stat_ids():
    return ['pass_cmp', 'pass_att', 'pass_cmp_perc', 'pass_yds', 'pass_td', 'pass_int', 'pass_rating', 'pass_sacked',
